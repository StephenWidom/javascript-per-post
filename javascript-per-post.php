<?php /*
Plugin Name: JavaScript Per Post
Plugin URI: https://github.com/StephenWidom/javascript-per-post
Description: Add meta box to each post and page for javascript to be executed only on said post or page
Version: 0.1
Author: Stephen Widom for Strategic Insight
License: GPL
 */
...
function jspp_meta_box_add() {
    ...
    if (current_user_can('administrator'))
        add_meta_box('jspp-meta-box-id', 'Post-Specific JavaScripts', 'jspp_meta_display', array('page', 'post', 'news', 'surveys', 'in-depth'), 'normal', 'high');
